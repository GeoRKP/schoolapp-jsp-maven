package gr.aueb.cf.schoolapppro.dao.student;
...
public class StudentDAOImpl implements IStudentDAO {
    ...
    public Student insertStudent(Student student) throws StudentDAOException {
        String sql = "INSERT INTO STUDENTS (FIRSTNAME, LASTNAME, GENDER, CITY_ID, USER_ID, BIRTH_DATE) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public Student updateStudent(Student student) throws StudentDAOException {
        String sql = "UPDATE STUDENTS SET FIRSTNAME = ?, LASTNAME = ?, GENDER = ?, CITY_ID = ?, USER_ID = ?, BIRTH_DATE = ? WHERE ID = ?";
        try (Connection connection = DBUtil.getConnection();
