...
public class MeetingDAOImpl implements IMeetingDAO{
    ...
    public Meeting insertMeeting(Meeting meeting) throws MeetingDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            ps.setDate(4, java.sql.Date.valueOf(meeting.getMeetingDate()));
    ...
    public Meeting updateMeeting(Meeting meeting) throws MeetingDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            insertPs.setDate(4, java.sql.Date.valueOf(meeting.getMeetingDate()));
    ...
    @Override
    public List<Meeting> getMeetingByDate(LocalDate meetingDate) throws MeetingDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    LocalDate date = rs.getObject("MEETING_DATE", LocalDate.class);
    ...
    public List<Meeting> getAllMeetings() throws MeetingDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            throw new MeetingDAOException("Error retrieving all meetings");
        }
